...
# Data specifications
# parser.add_argument('--dir_data', type=str, default='/home/yue/Yue/HR_dataset',
#                     help='dataset directory')
parser.add_argument('--dir_data', type=str, default='/home/wy/Documents/HR_dataset',
                    help='dataset directory')
...
parser.add_argument('--data_test_tt', type=str, default='Set14_test',
                    help='test dataset name')
parser.add_argument('--data_test1', type=str, default='RealSR_TEST',
                    help='test dataset name')
...
parser.add_argument('--model', default='blindsr_imdn_nn_tt',
                    help='model name')
parser.add_argument('--model_pre_train', type=str, default= './model/IMDN/checkpoints/IMDN_x4.pth',
                    help='pre-trained model directory')
# parser.add_argument('--model_kernel_dir', type=str, default= '../pretrain_model/kernel_72_k5.pkl',
#                     help='kernel model directory')
...
parser.add_argument('--model_scale', type=int, default=4,
                    help='number of epochs to train the degradation encoder')
parser.add_argument('--model_in_channel', type=int, default=3,
                    help='number of epochs to train the degradation encoder')
parser.add_argument('--model_n_channel', type=int, default=32,
                    help='number of epochs to train the degradation encoder')
parser.add_argument('--model_res_block', type=int, default=4,
                    help='number of epochs to train the degradation encoder')
parser.add_argument('--model_n_weight', type=int, default=72,
                    help='number of epochs to train the degradation encoder')
...
parser.add_argument('--epochs_encoder', type=int, default=100,
                    help='number of epochs to train the degradation encoder')
parser.add_argument('--epochs_sr', type=int, default=700,
...
# Log specifications
parser.add_argument('--save', type=str, default='Eval_blindsr_lmbd_nn_tt_experi',
...
parser.add_argument('--pre_train', type=str, default= '../model_pth',
                    help='pre-trained model directory')
